...
/etc/init.d/trove-api stop
/etc/init.d/trove-conductor stop
/etc/init.d/trove-conductor stop
...
openstack-config --set /etc/trove/trove.conf DEFAULT taskmanager_manager trove.taskmanager.manager.Manager
...
/etc/init.d/trove-conductor restart
chkconfig trove-api on
chkconfig trove-taskmanager on
chkconfig trove-conductor on
