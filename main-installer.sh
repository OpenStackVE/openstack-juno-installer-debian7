...
"install")
	...
	echo "Versión 1.0.2.deb7 \"Shadow Cat\" - Noviembre 26, 2014"
	echo ""
	...
	echo "  * http://archive.gpkhost.com/debian juno main"
	echo "  * http://archive.gplhost.com/debian juno-backports main"
